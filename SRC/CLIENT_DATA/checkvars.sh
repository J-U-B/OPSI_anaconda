...
#
# Version: 1.2.1
# Jens Boettge <boettge@mpi-halle.mpg.de>  	2020-11-29 21:10:44 +0100
#===========================================================

VARS_DEFINED=$(grep -i -P -e 'def(Var|StringList)' variables.opsiinc* checkinstance.opsiinc | sed -e 's/^\s+//' -e 's/\s+/ /g' | awk -e '{print $2}' | sort )
